<?php
// search.php - Halaman utama untuk browsing genre dan album
...
// Get popular genres (with song count)
...
$playlists_stmt->execute([$user_id]);
    ...
    $search_stmt->execute([$user_id, $search_param, $search_param, $search_param]);
...
// Jika genre dipilih, get songs for that genre
if ($genre_id > 0) {
    // Get genre name
    ...
    $genre_songs_stmt->execute([$user_id, $genre_id]);
                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="results-count-badge">
                            <i class="fas fa-music"></i> <?php echo number_format($total_search_results); ?> results
                        </div>
                    </div>
                    ...
                    <?php else: ?>
                        <div class="no-content">
                            ...
                            <a href="search.php" class="btn-primary" style="margin-top: 1rem;">Browse All Genres</a>
                        </div>
                    <?php endif; ?>
                </section>
            ...
            <?php else: ?>
                ...
                <section class="section">
                    ...
                    <div class="genres-grid-simple">
                        ...
                        <a href="search.php?genre=<?php echo $genre['id']; ?>" class="genre-card-simple" style="--genre-color: <?php echo $genre['color']; ?>">
